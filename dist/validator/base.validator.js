...
exports.assertCateRow = (row, isJson) => {
    ...
    assert(utils_1.isNotEmpty(category_code) && utils_1.isNotEmpty(category_name) && utils_1.isNotEmpty(created_date) && utils_1.isNotEmpty(last_updated_date), getErrorMsg(enums_1.ERROR_MESSAGE.NOT_FOUND_REQUIRED_COL_ERROR, row));
...
exports.assertItemRow = (row, isJson) => {
    ...
    assert(utils_1.isNotEmpty(item_code) &&
        utils_1.isNotEmpty(category_code) &&
        utils_1.isNotEmpty(title) &&
        utils_1.isNotEmpty(image_url) &&
        utils_1.isNotEmpty(created_date) &&
        utils_1.isNotEmpty(last_updated_date), getErrorMsg(enums_1.ERROR_MESSAGE.NOT_FOUND_REQUIRED_COL_ERROR, row));
...
exports.assertRevwRow = (row, isJson) => {
    ...
    assert(utils_1.isNotEmpty(item_code) &&
        utils_1.isNotEmpty(review_code) &&
        utils_1.isNotEmpty(review) &&
        utils_1.isNotEmpty(created_date) &&
        utils_1.isNotEmpty(last_updated_date), getErrorMsg(enums_1.ERROR_MESSAGE.NOT_FOUND_REQUIRED_COL_ERROR, row));
    if (utils_1.isNotEmpty(is_deleted)) {
        assert(['Y', 'N'].includes(is_deleted), getErrorMsg(enums_1.ERROR_MESSAGE.IS_DELETED_FORMAT_ERROR, row));
