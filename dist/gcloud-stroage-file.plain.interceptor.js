...
exports.GCloudStorageFilePlainInterceptor = void 0;
const common_1 = require("@nestjs/common");
const platform_express_1 = require("@nestjs/platform-express");
const gcloud_storage_service_1 = require("./gcloud-storage.service");
const path_1 = require("path");
const moment = require("moment-timezone");
function GCloudStorageFilePlainInterceptor(fieldName, localOptions, gcloudStorageOptions, storagePath) {
        ...
        intercept(context, next) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (bno && storagePath) {
                    ...
                    path = path_1.join(storagePath, `${bno}/${partition}`);
                }
                if (!file) {
...
exports.GCloudStorageFilePlainInterceptor = GCloudStorageFilePlainInterceptor;
